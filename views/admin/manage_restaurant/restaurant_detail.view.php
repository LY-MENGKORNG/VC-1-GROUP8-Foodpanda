    ...
    <div class="card mx-2 stat-cards-item">
        <div class="row g-0 d-flex">
            <div class="col-md-6 d-flex">
                <img src="<?= $target_file_dir . $restaurant["restaurant_img"] ?>" class="rounded" alt="..." style="width: 100%; margin: auto;">
            </div>
            <div class="col-md-6 d-flex flex-column justify-content-between p-0">
                <div class="card-body d-flex flex-column justify-content-between">
                    <div class="">
                        ...
                        <h5 class="stat-cards-info__num mb-3" style="font-size: 1.2rem;">Owner: <span class="stat-cards-info__title" style="font-size: 1rem;"><?= $restaurant["owner_id"] ?></span></h5>
