<div class="osahan-profile">
    ...
    <div class="container position-relative">
        <form action="/admin/edit_profile" method="post" enctype="multipart/form-data" class="py-5 osahan-profile row">
            <div class="col-md-4 mb-3 card-stat">
                <div class="rounded shadow-sm sticky_sidebar overflow-hidden p-5 d-flex flex-column border border-secondary align-items-center">
                    <input type="file" name="profile" id="profile" style="display: none;">
                    <div class="left rounded-circle d-flex align-items-center position-relative border rounded-circle overflow-hidden" style="width: 150px; height: 150px;">
                        <img alt="#" src="../../assets/images/uploads/admin_profile/<?= isset($admin["profile"]) ? $admin["profile"] : 'avatar.png' ?>" class="rounded-circle" style="width: 100%;">
                    </div>
                    <div class="rounded-circle bg-white border position-absolute d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; bottom: 40%; right: 30%">
                    ...
                    <div class="d-flex  d-flex flex-column gap-5 p-3">
                        <div class="left text-center">
                            <h6 class="mb-1 main-title font-weight-bold"><?= $admin["first_name"] . " " . $admin["last_name"] ?><i class="feather-check-circle text-success"></i></h6>
            ...
            <div class="col-md-8 mb-3">
                <div class="rounded shadow-sm p-4 border border-secondary">
                    <h5 class="mb-4 main-title">My account</h5>
                    <div id="edit_profile">
                        <div>
                            <div class="row">
