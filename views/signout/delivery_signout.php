        ...
        <div class="d-flex align-items-center justify-content-center vh-100">
            <div class="px-5 col-md-6 ml-auto">
                <div class="px-5 col-10 mx-auto">
                    <h2 class="my-0" style="color: #FF2B85;">Sign out of Foodpanda</h2>
                    <p class="text-50"></p>
                    <form class="mt-5 mb-4" action="/delivery/check_signout" method="post">
                        <div class="form-group">
                            ...
                            <p class="text-danger"><?= isset($_SESSION["is_delivery_email"]) ? $_SESSION["is_delivery_email"] : "" ?></p>
                        </div>
                        <div class="form-group">
                            <label for="password" class="text-dark">Password</label>
                            <input type="password" name="password" placeholder="Enter Password" class="form-control" id="password" required />
                            <p class="text-danger"><?= isset($_SESSION["is_delivery_password"]) ? $_SESSION["is_delivery_password"] : "" ?></p>
                        </div>
