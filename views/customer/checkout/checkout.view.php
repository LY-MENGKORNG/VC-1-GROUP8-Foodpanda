                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-8 form-group">
                        ...
                        <input type="text" name="valid_through" id="validThrough"
                          placeholder="Enter Valid through(MM/YY)" maxlength="5" pattern="(0[1-9]|1[0-2])\/\d{2}"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-row">
              ...
              <div class="col-md-12 form-group d-flex flex-column">
                ...
                <div class="input-group">
                  <input name="address_name" placeholder="e.g. Phnom Penh Cambodia" type="text"
          ...
          <div class="modal-footer row p-0 border-0">
            <div class="col-6 m-0 p-0 row">
              <button type="button" class="btn border-top col-12" data-dismiss="modal">Close</button>
            </div>
            <div class="col-6 m-0 p-0 row">
              <button type="button" id="addAddress" class="btn btn-primary col-12">Save
                changes</button>
            </div>
          </div>
        </div>
                            ...
                            <form action="/customer/editAddress" id="formEdit<?= $address["address_id"] ?>" method="post">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="form-row">
                                    <div class="col-md-12 form-group">
                                      <label class="form-label" for="editDeliveryId">Delivery Address</label>
                                      <div class="input-group">
                                        <select name="delivery_id" class="form-control" id="editDeliveryId">
                                          <?php foreach ($deliveries as $delivery) { ?>
                                    ...
                                    <div class="col-md-12 form-group">
                                      ...
                                      <div class="input-group" >
                                        <input name="address_name" placeholder="e.g. Phnom Penh Cambodia"
                                          type="text" class="form-control" id="editAddressInput"
                                ...
                                <div class="modal-footer p-0 border-0">
                                  ...
                                  <div class="col-6 m-0 p-0">
                                    <button type="button" id="editAddress" class="btn btn-primary btn-lg btn-block">Save
                                      changes</button>
                                  </div>
                                </div>
                              </div>
