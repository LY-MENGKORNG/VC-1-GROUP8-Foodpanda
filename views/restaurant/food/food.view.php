                            ...
                            <td>
                                <label class="users-table__checkbox">
                                    ...
                                    <div class="categories-table-img">
                                        <picture class="">
                                            <source
                                                srcset="../../assets/images/uploads/restaurants/foods/<?= isset($item["image"]) ? $item["image"] : 'Salad.png' ?>"
                                                type="image/webp">
                                            <div class="rounded overflow-hidden" style="width: 60px; height: 40px;">
                                                <img src="../../assets/images/uploads/restaurants/foods/<?= isset($item["image"]) ? $item["image"] : 'Salad.png' ?>"
                                                    alt="food">
                                            </div>
                                        </picture>
                                    </div>
